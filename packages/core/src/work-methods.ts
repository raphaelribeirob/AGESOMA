export type InternalWorkMethodId = "consorcio_sales_v1";

export type InternalWorkMethod = {
  id: InternalWorkMethodId;
  market: string;
  job: string;
  stages: string[];
...
const CONSORCIO_SALES: InternalWorkMethod = {
...
export function resolveInternalWorkMethod(request: string): InternalWorkMethod | null {
